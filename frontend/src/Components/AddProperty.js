...
function AddProperty() {
  ...
  useEffect(() => {
    if (state.areaValue && state.boroughValue) {
      ...
      const currentAreaOptions = state.areaValue === "Inner London" ? innerLondonOptions : outerLondonOptions;
      const isValidBorough = currentAreaOptions.some(option => option.value === state.boroughValue);
...
useEffect(() => {
		if (state.mapInstance && state.boroughValue === "Camden") {
			...
			// });
		} else if (state.mapInstance && state.boroughValue === "Greenwich") {
			...
			// });
		} else if (state.mapInstance && state.boroughValue === "Hackney") {
			...
			// });
		} else if (state.mapInstance && state.boroughValue === "Hammersmith and Fulham") {
			...
			// });
		} else if (state.mapInstance && state.boroughValue === "Islington") {
			...
			// });
		} else if (state.mapInstance && state.boroughValue === "Kensington and Chelsea") {
			...
			// });
		} else if (state.mapInstance && state.boroughValue === "Lambeth") {
			...
			// });
		} else if (state.mapInstance && state.boroughValue === "Lewisham") {
			...
			// });
		} else if (state.mapInstance && state.boroughValue === "Southwark") {
			...
			// });
		} else if (state.mapInstance && state.boroughValue === "Tower Hamlets") {
			...
			// });
		} else if (state.mapInstance && state.boroughValue === "Wandsworth") {
			...
			// });
		} else if (state.mapInstance && state.boroughValue === "Westminster") {
			...
			// });
		} else if (state.mapInstance && state.boroughValue === "City of London") {
			...
			// });
		} else if (state.mapInstance && state.boroughValue === "Barking and Dangenham") {
			...
			// });
		} else if (state.mapInstance && state.boroughValue === "Barnet") {
			...
			// });
		} else if (state.mapInstance && state.boroughValue === "Bexley") {
			...
			// });
		} else if (state.mapInstance && state.boroughValue === "Brent") {
			...
			// });
		} else if (state.mapInstance && state.boroughValue === "Bromley") {
			...
			// });
		} else if (state.mapInstance && state.boroughValue === "Croydon") {
			...
			// });
		} else if (state.mapInstance && state.boroughValue === "Ealing") {
			...
			// });
		} else if (state.mapInstance && state.boroughValue === "Enfield") {
			...
			// });
		} else if (state.mapInstance && state.boroughValue === "Haringey") {
			...
			// });
		} else if (state.mapInstance && state.boroughValue === "Harrow") {
			...
			// });
		} else if (state.mapInstance && state.boroughValue === "Havering") {
			...
			// });
		} else if (state.mapInstance && state.boroughValue === "Hillingdon") {
			...
			// });
		} else if (state.mapInstance && state.boroughValue === "Hounslow") {
			...
			// });
		} else if (state.mapInstance && state.boroughValue === "Kingston upon Thames") {
			...
			// });
		} else if (state.mapInstance && state.boroughValue === "Merton") {
			...
			// });
		} else if (state.mapInstance && state.boroughValue === "Newham") {
			...
			// });
		} else if (state.mapInstance && state.boroughValue === "Redbridge") {
			...
			// });
		} else if (state.mapInstance && state.boroughValue === "Richmond upon Thames") {
			...
			// });
		} else if (state.mapInstance && state.boroughValue === "Sutton") {
			...
			// });
		} else if (state.mapInstance && state.boroughValue === "Waltham Forest") {
  ...
  return (
    <div style={formContainer}>
      ...
      <Button 
        onClick={() => state.mapInstance && state.mapInstance.setView([51.53, -0.09], 15)}
