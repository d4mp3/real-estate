    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area', models.CharField(blank=True, choices=[('Inner Warsaw', 'Inner Warsaw'), ('Outer Warsaw', 'Outer Warsaw')], max_length=20, null=True)),
                ...
                ('rental_frequency', models.CharField(blank=True, choices=[('Mont', 'Month'), ('Week', 'Week'), ('Day', 'Day')], max_length=20, null=True)),
